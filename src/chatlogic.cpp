...
ChatLogic::~ChatLogic()
{
    ...
    // delete _chatBot;    _chatBot is owned by graphnode.

    // delete all nodes (Smart ptr take care of them)
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            edge->SetChildNode((*childNode).get());     // iterator point to the smart ptr 
